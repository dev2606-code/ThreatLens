        ...
        <aside className="fixed inset-y-0 left-0 z-30 hidden w-64 border-r border-white/[0.07] bg-[#050810] lg:flex lg:flex-col">
          ...
          <div className="p-4">
            ...
            <button
              ...
              className="mb-4 flex w-full items-center gap-3 rounded-xl border border-transparent px-4 py-3 text-sm text-red-400 transition hover:border-red-500/20 hover:bg-red-500/10"
            >
            ...
            <div className="rounded-2xl border border-violet-500/15 bg-gradient-to-b from-violet-500/10 to-transparent p-4">
